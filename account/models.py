...
class Profile(models.Model):
    ...
    fast = models.PositiveSmallIntegerField(null=True, blank=True)
    salavat = models.PositiveSmallIntegerField(null=True, blank=True)
    prayer = models.PositiveSmallIntegerField(null=True, blank=True)
    quran = models.PositiveSmallIntegerField(null=True, blank=True)
